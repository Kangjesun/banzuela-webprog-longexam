    ...
    <div className="flex w-full flex-col gap-6">
      <section className="border-y-2 border-yellow-400 bg-blue-950/95 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          <div className="rounded-3xl border-2 border-dashed border-yellow-400 bg-zinc-100 p-6">
            <div className="flex min-h-72 items-center justify-center rounded-[1.25rem] bg-zinc-200">
               <img src="/src/assets/img/About.jpg" alt="Daily Essentials" className="h-flex w-flex object-cover rounded-xl" />
            </div>
          </div>
      ...
      <section className="border-y-2 border-yellow-400 bg-blue-950/95 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-3xl border-2 border-yellow-400 bg-zinc-100 p-5">
          ...
          <div className="rounded-3xl border-2 border-yellow-400 bg-zinc-100 p-5">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src="/src/assets/img/nu_volleyball_sticker.png" alt="Study Suppliess" className="h-flex w-flex object-cover rounded-xl" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src="/src/assets/img/nu_cap.png" alt="Study Suppliess" className="h-flex w-flex object-cover rounded-xl" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src="/src/assets/img/nu_lanyard.png" alt="Study Suppliess" className="h-flex w-flex object-cover rounded-xl" />
              </div>
              <div className="flex aspect-square items-center justify-center rounded-[1.25rem] bg-zinc-200">
                <img src="/src/assets/img/nu_varsity_jacket.png" alt="Study Suppliess" className="h-flex w-flex object-cover rounded-xl" />
              </div>
            </div>
