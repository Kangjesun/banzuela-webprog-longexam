...
import Logo from "../assets/img/nubdexchange_logo.png"; // change path if needed

const Footer = () => {
  return (
    <footer className="border-t-2 border-zinc-900 bg-zinc-900 px-2 py-6">
  <div className="mx-auto max-w-4xl flex items-start justify-between">
   ...
   <img
    src={Logo}
    alt="BulldogEx Logo"
    className="h-10 w-10 mt-[30px] rounded-md object-cover border border-zinc-700"
  />
  ...
  <div className="mx-auto mt-4 max-w-4xl border-t border-zinc-700 pt-3 text-center text-[10px] text-zinc-500">
